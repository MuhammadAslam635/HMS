    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="clients.html"><i class="la la-users"></i> <span>Pharmacy Management</span></a>
                </li>
                <li>
                    <a href="clients.html"><i class="la la-users"></i> <span>Blood Management</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="clients.html"><i class="la la-users"></i> <span>Hospital Reports</span></a>
                </li>
