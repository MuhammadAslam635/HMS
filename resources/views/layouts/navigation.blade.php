<div class="header">
    ...
    <ul class="nav user-menu">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Rolland
                                                Webber</span> completed task <span class="noti-title">Patient and Doctor video
                                                conferencing</span></p>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Bernardo
                                                Galaviz</span> added new task <span class="noti-title">Private chat module</span></p>
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <span class="user-img"><img class="mt-3" src="{{asset('assests/images/users')}}/{{Auth::user()->profile_photo_path}}" style="border-radius:69px;border:solid 1px white;width:22px;">
                    <span class="status online mb-2"></span></span>
